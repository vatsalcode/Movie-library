...
class BookAdd extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(book == null ? 'Add a Movie' : 'Update Movie'),
      ),
    ...
    return Form(
      ...
      child: Column(
        ...
        children: <Widget>[
          BookTextFormField(
            labelText: 'Title',
            errorText: 'Enter a Movie title',
            initialValue: widget.book?.title,
            onSaved: (value) => _title = value,
          ),
          BookTextFormField(
            labelText: 'Director',
            errorText: 'Enter the Director',
            onSaved: (value) => _author = value,
            initialValue: widget.book?.author,
          ),
          BookTextFormField(
            labelText: 'Description of Movie',
          ...
          InputDecorator(
            decoration: InputDecoration(
              labelText: 'Rating you give to movie',
          ...
          Padding(
            ...
            child: ConfirmButton(
              text: widget.book == null ? 'Add Movie' : 'Update Movie',
              onPressed: () {
