...
final initialBooks = [
  Book(
    ...
    'Laurel Toven',
    'In this movie, we have a geographical historical and cultural region in the wester, part of the country of Belgium',
  ...
  Book(
    'Norse Mythology',
    'Neil Gaiman',
    'The immortal #1 New York Times best watched movie',
  ...
  Book(
    ...
    'Junot Diaz',
    'Winner of the Pulitzer Prize for best movie',
...
final bookToAdd = Book(
  'Harry Potter',
  'JK Rowling',
  'In an age with kings and kings movie',
